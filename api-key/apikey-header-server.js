...
<body>
  ...
  <div class="container">
    <div class="card">
      ...
      <label>Request URL (clean — no key in URL)</label>
      <div class="url-preview" id="url-preview">GET http://localhost:3057/api/weather</div>
      <label>Authorization header (key sent here)</label>
      <div class="header-preview" id="header-preview">Authorization: Bearer sk_test_demo_...</div>
      <div class="btn-row">
    ...
    <div class="card">
      ...
      <p style="font-size:0.85rem;color:#94a3b8;margin-bottom:0.75rem">
        Logs show clean URLs — the API key is in the Authorization header, not the request path.
      </p>
      <div class="btn-row">
...
app.get('/api/logs', function (req, res) {
  res.json({
    note: 'Access logs show clean URLs — API key is in Authorization header, not logged here.',
...
app.listen(PORT, function () {
  console.log('DataPipe (header key) running at http://localhost:' + PORT);
});
