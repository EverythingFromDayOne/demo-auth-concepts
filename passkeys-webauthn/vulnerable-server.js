...
const HTML = `<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>CloudPortal Weak WebAuthn</title>
<style>
...
.warn{background:#fef3c7;border:1px solid #d97706;color:#78350f;padding:.6rem;border-radius:6px;font-size:.84rem}
...
<div class="warn">⚠️ WEAK WEBAUTHN: User verification is discouraged. No biometric will be prompted.</div>
